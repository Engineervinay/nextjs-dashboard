...
export default function ContainerReferal() {
  return (
    <div className='container-sm w-5/12 p-8 pb-0 bg-white shadow-xl rounded-md'> 
    <div className='flex flex-column flex-wrap justify-items-center justify-center gap-5'>  
