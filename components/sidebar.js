    ...
    return(
        <div className='h-screen py-4 px-4 pb-8 mr-0 pr-0 bg-bgcolor dark:bg-darkbg flex justify-start flex-col align-start w-56 gap-5'>
            <div className='flex flex-row justify-end '>
                ...
                onClick={() => setTheme(theme === 'dark' ? 'light' : 'dark')}>{theme=='dark' ? (<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
